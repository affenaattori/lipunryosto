...
public class DeviceController : ControllerBase
{
    ...
    private readonly IOptions<CaptureOptions> _cap; 
    private readonly IHubContext<AdminHub> _admin; 
    private readonly IHubContext<PublicHub> _public;

    public DeviceController(AppDb db, OtpService otp, ScoringService scoring, IOptions<CaptureOptions> cap, IHubContext<AdminHub> admin, IHubContext<PublicHub> pub)
    {
